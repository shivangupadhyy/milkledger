    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-900 text-slate-100 px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md z-10">
        <div className="text-center mb-8">
          <div className="bg-white px-5 py-2.5 rounded-2xl shadow-lg border border-slate-700/30 inline-flex items-center justify-center mb-5 hover:scale-105 transition-transform duration-300 mx-auto">
            <img src="/logo.png" alt="MilkLedger Logo" className="h-10 object-contain" />
          </div>
